...
/**
 * Store owners share the same user account credentials as regular users,
 * so this page hits the same API route as the user security page.
 * The only difference is the layout context (store dashboard shell).
 */
export function StoreSecurityPage({ storeId }: { storeId: string }) {
      ...
      <div className="flex items-center gap-3 mb-8">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Update your store login credentials
          </p>
        </div>
      </div>
