        ...
        {loading ? (
          ...
          <div className="relative">
            ...
            {showSeeMore && (
              <button
                onClick={() => scroll("left")}
                className="absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-soraxi-green hover:bg-soraxi-green-hover shadow-md rounded-full p-2 cursor-pointer text-white"
              >
            ...
            {showSeeMore && (
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-soraxi-green hover:bg-soraxi-green-hover shadow-md rounded-full p-2 cursor-pointer text-white"
              >
